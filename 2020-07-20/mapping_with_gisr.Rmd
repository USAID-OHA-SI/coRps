...
## Making Maps with gisr package

Introduction to geospatial analytics packages: st, raster, sf, rnaturalearth, and gisr
...
`raster` is good for raster data (imagery) processing and allows for Geodata Data Extraction and Manipulation
