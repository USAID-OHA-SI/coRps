...
Let's download geodata with raster package - this will download rds file
...
# from raster package
get_adm_boundaries(country_code = "GHA", geo_path = "GIS")
...
gisr::terrain_map(countries = list("Ivory Coast"), terr_path = "../../../GEODATA/RASTER")

gisr::terrain_map(countries = list("Ivory Coast"), terr_path = "../../../GEODATA/RASTER", mask = TRUE)

gisr::terrain_map(countries = list("Ivory Coast"), terr_path = "../../../GEODATA/RASTER", add_neighbors = TRUE)

gisr::admins_map(countries = list("Ivory Coast"), add_neighbors = TRUE)
