...
For a more in-depth dive in how to tidy the UNAIDS data, check out our [CoRps session](https://github.com/USAID-OHA-SI/coRps/blob/main/2021-11-08/02_munge_unaids_function_example.R) about `munge_unaids`, the cleaning and tidying function that we built to tidy this data.
